...
export function SubmissionHistory({ attempts, currentAttempt, maxAttempts }: SubmissionHistoryProps) {
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="text-left">
            ...
            <p className="text-xs text-gray-500">
              ...
              {remainingAttempts > 0 ? ` ${remainingAttempts} remaining` : ' No attempts remaining'}
            </p>
          </div>
        </div>
        <svg
