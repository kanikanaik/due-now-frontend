      ...
      <div className="flex items-start gap-3 pr-6">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            ...
            `}>
              {announcement.type === 'global' ? 'Announcement' : 'Clarification'}
            </span>
          </div>
...
export function AnnouncementList({ announcements, onDismiss, maxItems = 5 }: AnnouncementListProps) {
...
export function AssignmentAnnouncements({ announcements }: AssignmentAnnouncementsProps) {
